...
var ngApp = angular.module('starter', ['ionic', 'satellizer', 'ngFileUpload', 'starter.controllers', 'starter.factories', 'ngCordova']);
...
ngApp.constant("CONFIG", {
  ...
  "contactNo": "",
  "cloudinaryPreset":'gfgzldou',
  "cloudinaryURL":'https://api.cloudinary.com/v1_1/logic-square/image/upload'
})
